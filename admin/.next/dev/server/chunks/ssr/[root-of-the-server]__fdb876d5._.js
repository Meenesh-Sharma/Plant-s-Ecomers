...
function GuidePage() {
    ...
    const fetchPlants = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API}/plant-care`);
            setPlants(res.data);
    ...
    const handleSave = async ()=>{
        ...
        try {
            if (editingPlant) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${API}/plant-care/${editingPlant._id}`, form);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API}/plant-care`, form);
            }
            fetchPlants();
            setOpenDialog(false);
        } catch (err) {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`${API}/plant-care/${id}`);
            fetchPlants();
        } catch (err) {
            console.error(err);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdb876d5._.js.map