...
"[project]/app/data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let plants = [
    {
        ...
        price: 45,
        img: "https://placehold.co/800x600/86efac/374151?text=Monstera",
        description: "The iconic Swiss Cheese plant. Perfect statement piece.",
    ...
    },
    {
        ...
        price: 60,
        img: "https://placehold.co/800x600/fcd34d/374151?text=FiddleLeaf",
        description: "Big glossy leaves for a dramatic effect.",
...
"[project]/app/plants/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//   const plantData = initialPlants.find(p => p.id === plantId);
//   const [plant, setPlant] = useState<Plant | null>(plantData || null);
//   if (!plant) return <p>Plant not found</p>;
//   const handleDelete = () => {
//     const index = initialPlants.findIndex(p => p.id === plant.id);
//     if (index > -1) {
//       initialPlants.splice(index, 1);
//       router.push('/plants');
//     }
//   };
//   const handleUpdate = () => {
...
//       <img src={plant.img} alt={plant.name} className="w-full h-64 object-cover rounded mb-4" />
...
//         <select
//           value={plant.type}
//           onChange={(e) => setPlant({ ...plant, type: e.target.value as PlantType })}
//           className="border p-2 rounded w-full"
//         >
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/data.ts [app-ssr] (ecmascript)");
...
function PlantDetailPage() {
    ...
    const plantId = params.id;
    const plantData = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plants"].find((p)=>p.id === plantId);
    const [plant, setPlant] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(plantData || null);
    if (!plant) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        className: "p-6 text-center text-gray-500",
        children: "Plant not found"
    }, void 0, false, {
        fileName: "[project]/app/plants/[id]/page.tsx",
        lineNumber: 117,
        columnNumber: 22
    }, this);
    const handleDelete = async ()=>{
        const confirmed = confirm(`Are you sure you want to delete ${plant.name}?`);
        if (!confirmed) return;
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plants"].findIndex((p)=>p.id === plant.id);
        if (index > -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plants"].splice(index, 1);
            router.push('/plants');
        }
    // 🔥 Example API call:
    /*
    ...
    */ };
    const handleUpdate = async ()=>{
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plants"].findIndex((p)=>p.id === plant.id);
        if (index > -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plants"][index] = plant;
            alert('Updated successfully!');
            router.refresh();
        }
    // 🔥 Example API call:
    ...
    */ };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
            className: "w-full max-w-5xl shadow-md rounded-xl",
            children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    src: plant.img,
                                    alt: plant.name,
                                    className: "rounded-lg w-full max-w-sm h-64 object-cover border"
                                }, void 0, false, {
                                    fileName: "[project]/app/plants/[id]/page.tsx",
                                    lineNumber: 190,
                                    columnNumber: 15
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1f380e2._.js.map