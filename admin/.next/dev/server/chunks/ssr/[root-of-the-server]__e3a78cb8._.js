...
// //   const [editingPoint, setEditingPoint] = useState<CarePoint | null>(null);
...
// //   const [totalPages, setTotalPages] = useState(3); // dummy value
// //   const limit = 6;
// //   // Plant Type colors
// //   const plantTypeColors: Record<string, string> = {
// //     Indoor: 'bg-green-100 text-green-700',
// //     Outdoor: 'bg-teal-100 text-teal-700',
// //     'Regular Tree': 'bg-yellow-100 text-yellow-700',
// //     'Fruit Tree': 'bg-orange-100 text-orange-700',
// //   };
// //   useEffect(() => {
// //     // 🟢 Dummy care points (replace with API call)
// //     const dummyData: CarePoint[] = [
// //       {
// //         _id: 'c1',
// //         plantType: 'Indoor',
// //         plantName: 'Monstera Deliciosa',
// //         title: 'Watering',
// //         description: 'Water once a week when topsoil feels dry.',
// //         helpPoint: 'Avoid overwatering.',
// //       },
// //       {
// //         _id: 'c2',
// //         plantType: 'Indoor',
...
// //         title: 'Sunlight',
// //         description: 'Prefers indirect bright sunlight.',
// //         helpPoint: 'Can tolerate shade.',
// //       },
// //       {
// //         _id: 'c3',
// //         plantType: 'Outdoor',
// //         plantName: 'Aloe Vera',
// //         title: 'Soil Type',
// //         description: 'Use well-draining cactus soil.',
// //         helpPoint: 'Add sand to regular potting mix.',
// //       },
// //     ];
// //     setCarePoints(dummyData);
// //   }, [page]);
// //   const openAddDialog = () => {
// //     setEditingPoint(null);
// //     setForm({ plantType: '', plantName: '', title: '', description: '', helpPoint: '' });
// //     setOpenDialog(true);
// //   };
// //   const openEditDialog = (point: CarePoint) => {
// //     setEditingPoint(point);
// //     setForm({
// //       plantType: point.plantType,
// //       plantName: point.plantName,
// //       title: point.title,
// //       description: point.description,
// //       helpPoint: point.helpPoint || '',
// //     });
// //     setOpenDialog(true);
// //   };
// //   const handleSave = async () => {
// //     if (!form.plantType || !form.plantName || !form.title || !form.description) {
// //       alert('Please fill all required fields');
// //       return;
// //     }
// //     if (editingPoint) {
// //       // await axios.put(`/api/carepoints/${editingPoint._id}`, form, { withCredentials: true });
// //       setCarePoints((prev) =>
// //         prev.map((p) => (p._id === editingPoint._id ? { ...p, ...form } : p))
// //       );
// //     } else {
// //       // const res = await axios.post('/api/carepoints', form, { withCredentials: true });
// //       const newPoint: CarePoint = { _id: Math.random().toString(), ...form };
// //       setCarePoints((prev) => [...prev, newPoint]);
// //     }
// //     setOpenDialog(false);
// //   };
// //   const handleDelete = async (id: string) => {
// //     if (!confirm('Are you sure you want to delete this care point?')) return;
// //     // await axios.delete(`/api/carepoints/${id}`, { withCredentials: true });
// //     setCarePoints((prev) => prev.filter((p) => p._id !== id));
// //   };
// //   const nextPage = () => {
...
// //         <h1 className="text-2xl font-bold">🌿 Plant Care & Help Points</h1>
// //         <Button
// //           onClick={openAddDialog}
// //           className="bg-green-600 hover:bg-green-700 text-white"
// //         >
// //           <Plus className="mr-1 w-4 h-4" /> Add Care Point
// //         </Button>
// //       </div>
// //       {/* Cards Grid */}
// //       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
// //         {carePoints.map((point) => (
// //           <Card key={point._id} className="hover:shadow-md transition">
// //             <CardHeader className="flex justify-between items-start">
// //               <div>
// //                 <CardTitle>{point.title}</CardTitle>
// //                 <CardDescription>{point.plantName}</CardDescription>
// //               </div>
// //               {point.plantType && (
// //                 <span className={`text-xs px-2 py-1 rounded-full font-medium ${plantTypeColors[point.plantType]}`}>
// //                   {point.plantType}
// //                 </span>
// //               )}
// //             </CardHeader>
...
// //                 {point.helpPoint || 'No help point added.'}
// //               </p>
...
// //           <DialogHeader>
// //             <DialogTitle>{editingPoint ? 'Edit Care Point' : 'Add New Care Point'}</DialogTitle>
// //           </DialogHeader>
// //           <div className="space-y-3">
// //             <Select
// //               value={form.plantType}
// //               onValueChange={(v) => setForm({ ...form, plantType: v })}
// //             >
// //               <SelectTrigger>
...
// //             />
// //             <Input
// //               placeholder="Title (e.g., Watering Tips)"
// //               value={form.title}
...
// //             />
// //             <Input
// //               placeholder="Help Point (optional)"
// //               value={form.helpPoint}
// //               onChange={(e) => setForm({ ...form, helpPoint: e.target.value })}
// //             />
// //           </div>
...
//         plantName: 'Rose',
//         title: 'Pruning',
//         description: 'Trim regularly',
//         helpPoint: 'Remove dead stems',
//       },
//     ];
//     setCarePoints(dummyData);
//   }, []);
...
//                   plantTypeColors[point.plantType] ||
...
//           <DialogHeader>
//             <DialogTitle>
//               {editingPoint ? 'Edit Care Point' : 'Add Care Point'}
//             </DialogTitle>
//           </DialogHeader>
//           <div className="space-y-3">
//             <Select
...
//             />
//             <Input
//               placeholder="Title (Watering, Light...)"
//               value={form.title}
//               onChange={(e) =>
...
//               value={form.helpPoint}
//               onChange={(e) =>
//                 setForm({ ...form, helpPoint: e.target.value })
//               }
//             />
//           </div>
//           <DialogFooter>
...
function GuidePage() {
    ...
    const [editingPlant, setEditingPlant] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    /* ================= DUMMY DATA ================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const dummy = [
            {
                _id: '1',
                plantType: 'Indoor',
                ...
                care: [
                    {
                        type: 'Watering',
                        tip: 'Water every 7–10 days'
                    },
                    {
                        type: 'Light',
                        tip: 'Bright indirect sunlight'
                    },
                    {
                        type: 'Soil',
                        tip: 'Well-draining soil'
                    }
                ]
            }
        ];
    ...
    /* ================= FORM HANDLERS ================= */ const openAddDialog = ()=>{
    ...
    /* 🔥 MULTIPLE CARE HANDLERS */ const addCareField = ()=>{
        setForm({
            ...form,
            care: [
                ...form.care,
    ...
    const updateCareField = (index, field, value)=>{
        const updated = [
            ...form.care
        ];
    ...
    /* ================= SAVE ================= */ const handleSave = ()=>{
        if (!form.plantName || !form.plantType) {
            alert('Fill required fields');
            return;
        }
        if (editingPlant) {
            setPlants((prev)=>prev.map((p)=>p._id === editingPlant._id ? {
                        ...p,
                        ...form
                    } : p));
        } else {
    ...
    /* ================= UI ================= */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: plants.map((plant)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                        className: "shadow-lg hover:shadow-xl transition-transform transform hover:-translate-y-1 rounded-2xl",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `text-xs px-3 py-1 rounded-full ${plantTypeColors[plant.plantType]}`,
                                        children: plant.plantType
                                    }, void 0, false, {
                                        fileName: "[project]/app/guide/page.tsx",
                                        lineNumber: 824,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    plant.care.map((tip, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogTitle"], {
                                children: editingPlant ? 'Edit Plant' : 'Add Plant'
                            }, void 0, false, {
                                fileName: "[project]/app/guide/page.tsx",
                                lineNumber: 869,
                                columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                form.care.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "border p-3 rounded-lg space-y-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                                                placeholder: "Type (Watering, Light...)",
                                                value: item.type,
                                                onChange: (e)=>updateCareField(index, 'type', e.target.value)
                                            }, void 0, false, {
                                                fileName: "[project]/app/guide/page.tsx",
                                                lineNumber: 915,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$textarea$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Textarea"], {
                                                ...
                                                value: item.tip,
                                                onChange: (e)=>updateCareField(index, 'tip', e.target.value)
                                            }, void 0, false, {
                                                fileName: "[project]/app/guide/page.tsx",
                                                lineNumber: 923,
                                                columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogFooter"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    className: "bg-green-600 hover:bg-green-700 text-white",
                                    onClick: handleSave,
                                    children: editingPlant ? 'Update' : 'Add'
                                }, void 0, false, {
                                    fileName: "[project]/app/guide/page.tsx",
                                    lineNumber: 951,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tabs"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TabsContent"], {
                        value: "care",
                        className: "space-y-4 mt-4 max-h-[50vh] overflow-y-auto",
                        children: [
                            form.care.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "border p-3 rounded-lg space-y-2",
                                    children: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3a78cb8._.js.map