...
function UsersPage() {
    ...
    const [totalPages, setTotalPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(3); // dummy total pages
    const limit = 6;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // 🟢 Dummy paginated data
        const dummyUsers = [
            {
                id: `U-20${page * 1}`,
                name: `User ${page}-1`,
                email: `user${page}-1@example.com`,
                role: 'customer'
            },
            {
                id: `U-20${page * 2}`,
                name: `User ${page}-2`,
                email: `user${page}-2@example.com`,
                role: 'customer'
            },
            {
                id: `U-20${page * 3}`,
                name: `Admin ${page}-3`,
                email: `admin${page}-3@example.com`,
                role: 'admin'
            },
            {
                id: `U-20${page * 4}`,
                name: `User ${page}-4`,
                email: `user${page}-4@example.com`,
                role: 'customer'
            },
            {
                id: `U-20${page * 5}`,
                name: `User ${page}-5`,
                email: `user${page}-5@example.com`,
                role: 'customer'
            },
            {
                id: `U-20${page * 6}`,
                name: `User ${page}-6`,
                email: `user${page}-6@example.com`,
                role: 'customer'
            }
        ];
        setUsers(dummyUsers);
    ...
    // axios.get(`/api/users?page=${page}&limit=${limit}&search=${search}`, { headers: { Authorization: `Bearer ${token}` } })
    //      .then(res => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c770eb13._.js.map