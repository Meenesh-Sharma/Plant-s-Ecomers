...
function GuidePage() {
    ...
    const [filteredPlants, setFilteredPlants] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchPlants = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API}/plant-care`);
            setPlants(res.data);
    ...
    const handleSave = async ()=>{
        ...
        try {
            if (editingPlant) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API}/plant-care/${editingPlant._id}`, form);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API}/plant-care`, form);
            }
            fetchPlants();
            setOpenDialog(false);
        } catch (err) {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API}/plant-care/${id}`);
            fetchPlants();
        } catch (err) {
            console.error(err);
        }
...
_s(GuidePage, "GrIJXXeHZb777Z/zz1RpuU9cL3g=");
_c = GuidePage;
var _c;
...
//# sourceMappingURL=_3254c1f2._.js.map