...
function OrdersPage() {
    ...
    const [editStatus, setEditStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Pending');
    // 🚀 Fetch Orders
    const fetchOrders = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/orders?page=${page}&limit=${limit}`);
    ...
    const handleSave = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/orders/${selectedOrder.id}`, {
                status: editStatus
            });
            fetchOrders(); // refresh
            setOpenDialog(false);
    ...
    const handleDelete = async (order)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/orders/${order.id}`);
            fetchOrders(); // refresh
        } catch (error) {
            console.error(error);
        }
...
_s(OrdersPage, "okyCjrzU/PQ581h8LMUNh8vunHM=");
_c = OrdersPage;
var _c;
...
//# sourceMappingURL=_1d746319._.js.map