...
function ReviewsPage() {
    ...
    const [currentAction, setCurrentAction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "ReviewsPage.useEffect": ()=>{
            const fetchReviews = {
                "ReviewsPage.useEffect.fetchReviews": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API}/api/reviews/all`);
                        setReviews(res.data);
                    } catch (error) {
                        console.error(error);
                    }
    ...
    const handleAction = async ()=>{
        ...
        try {
            ...
            if (currentAction === "accept") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API}/api/reviews/${id}`, {
                    status: "accepted"
                });
            ...
            if (currentAction === "reject") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API}/api/reviews/${id}`);
                    ...
                    ${review.status === "accepted" ? "bg-green-100 text-green-700" : review.status === "frozen" ? "bg-yellow-100 text-yellow-700" : "bg-gray-100 text-gray-700"}`,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: [
                                    ...
                                    review.message.length > 120 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(ReviewsPage, "XgmidCUPNAGikrfWi/fy0dLF8/E=");
_c = ReviewsPage;
var _c;
...
//# sourceMappingURL=_fa1f6770._.js.map