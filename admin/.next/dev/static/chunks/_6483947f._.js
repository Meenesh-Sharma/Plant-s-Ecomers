...
//           </DialogHeader>
//           <p>This action cannot be undone. The plant will be permanently deleted.</p>
//           <DialogFooter>
...
function PlantDetailPage() {
    ...
    const plantId = params.id;
    const [plant, setPlant] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Popup states
    ...
    const fetchPlant = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API}/api/plants/${plantId}`);
            setPlant(res.data);
        } catch (error) {
    ...
    const handleUpdate = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API}/api/plants/${plant._id}`, {
                name: plant.name,
                price: plant.price,
                img: plant.img,
    ...
    const handleDelete = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API}/api/plants/${plant._id}`);
            router.push('/plants');
        } catch (error) {
...
_s(PlantDetailPage, "KwTb7oKxKR743TtHxbqoyRZCdHM=", false, function() {
    return [
...
//# sourceMappingURL=_6483947f._.js.map