...
function UsersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UsersPage.useEffect": ()=>{
            const fetchUsers = {
                "UsersPage.useEffect.fetchUsers": async ()=>{
                    try {
                        setLoading(true);
                        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                        ;
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/auth/users`);
                        setUsers(res.data);
                    } catch (error) {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_BASE_URL}/api/auth/users/${id}`);
...
_s(UsersPage, "AcqkzofykKVp9xZ4PPrpHXpcJAQ=");
_c = UsersPage;
var _c;
...
//# sourceMappingURL=_40bbe0c2._.js.map